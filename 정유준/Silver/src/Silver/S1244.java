	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < studentNum; i++) {
			...
			if(gender == 1) {
				...
				while(((studentSwitchNum-girlCount-1) >= 0 && (studentSwitchNum + girlCount - 1) <= switchState.length-1 && switchState[studentSwitchNum-girlCount-1] == switchState[studentSwitchNum+girlCount-1])) {
					//해당 자리 index값이 1일 때
